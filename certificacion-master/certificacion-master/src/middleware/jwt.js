...
import { getUsuarioForValidation } from '../controllers/usuario.controllers.js';
...
export const emisionTokenUsuario = async (req, res, next) => {
    try {
        let { email, password } = req.body;
        getUsuarioForValidation(email, password)
        .then(usuario => {
